...
class XPINN_laminar_flow:
    ...
    def __init__(self, collo1, collo2, interface, INLET, OUTLET, internal1, internal2, CYLD1, CYLD2, WALL1, WALL2, uv_layers, lb, ub, ExistModel, uvDir):
        ...
        if use_internal == 0:
            ...
            self.loss2 = self.loss_f2 + 2*(self.loss_CYLD2 + self.loss_WALL2+ self.loss_OUTLET) + 30*self.loss_discontinuous2 + self.loss_continuity
...
if __name__ == "__main__":
    ...
    uv_layers = [[2] + 8*[40] + [6], [2] + 10*[40] + [6]]  # 2 i/p, 8 layers x 40 neurons each, 6 o/p
    ...
    # WALL = [x, y], u=v=0
    WALL_TOP = [xlb, yub] + [xub-xlb, 0.0] * lhs(2, 1500) #lhs = Latin-Hypercube from pyDOE
    ...
    WALL_BOTTOM = [xlb, ylb] + [xub-xlb, 0.0] * lhs(2, 1500)
    ...
    interface = [ixlb, iylb] + [-1, iyub-iylb] * lhs(2, N_interface)
